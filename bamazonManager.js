...
var bamazonApp = {
    ...
    lookup_products: function (app) {
        connection.query('SELECT * FROM products', function (error, results, fields) {
            ...
            app.questions[1].choices = app.product_choices;
            app.ask_questions(app);
    ...
    alter_product_quantity: function (app, product_name, new_quantity) {
        var update_query = "UPDATE products SET stock_quantity = '" + new_quantity + "' WHERE product_name='" + product_name + "'";
    ...
    add_to_product_quantity: function (app, product_name, quantity_to_add) {
        var update_query = "UPDATE products SET stock_quantity = stock_quantity + " + quantity_to_add + " WHERE product_name='" + product_name + "'";
        console.log(update_query);
        connection.query(update_query, function (error, results, fields) {
            if (error) throw error;
